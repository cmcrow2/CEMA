  ...
  return (
    <div className="sticky top-20 font-courier">
      ...
      >
        ...
        <div
          id="slideover"
          className="absolute flex flex-col w-full overflow-hidden items-center pt-8 pb-10 px-10 gap-y-4 text-xl border-b-[1px] border-black bg-sand-100 duration-500 ease-out transition-all z-10 -translate-y-[125%]"
        >
